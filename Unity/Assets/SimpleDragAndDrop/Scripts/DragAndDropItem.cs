...
public class DragAndDropItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	...
	[SerializeField] private DragAndDropItemProxy _dragAndDropItemProxy;
	...
	private void Start()
	{
		if (_dragAndDropItemProxy)
		{
			_dragAndDropItemProxy.OnBeginDragEvent += (data) =>
			{
				OnBeginDrag(data, true);
			};
			
			_dragAndDropItemProxy.OnDragEvent += (data) =>
			{
				OnDrag(data, true);
			};
			
			_dragAndDropItemProxy.OnEndDragEvent += (data) =>
			{
				OnEndDrag(data, true);
			};
		}
	...
	public void OnBeginDrag(PointerEventData eventData, bool proxy)
	{
		if (!proxy && _dragAndDropItemProxy != null)
			return;
	...
	public void OnDrag(PointerEventData data, bool proxy)
	{
		if (!proxy && _dragAndDropItemProxy != null)
			return;
	...
	public void OnEndDrag(PointerEventData eventData, bool proxy)
	{
		if (!proxy && _dragAndDropItemProxy != null)
			return;
